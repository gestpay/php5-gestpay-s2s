 ...
 * Time: 12:32
 *
 * This example shows a way to use callDeleteTokenS2S with the minimum required parameters.
 * callDeleteTokenS2S is described here: http://docs.gestpay.it/adv/delete-tokens.html
 * the API: http://api.gestpay.it/#calldeletetokens2s
 *
 */
...
try {
    $objectResult = $client->callDeleteTokenS2S($param);
...
$result = simplexml_load_string($objectResult->callDeleteTokenS2SResult->any);
